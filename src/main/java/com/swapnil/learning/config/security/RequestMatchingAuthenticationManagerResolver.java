 ...
 * 
 */
package com.swapnil.learning.config.security;
...
public class RequestMatchingAuthenticationManagerResolver implements AuthenticationManagerResolver<HttpServletRequest> {
	...
	/**
	 * Construct an {@link RequestMatchingAuthenticationManagerResolver} based on
	 * the provided parameters
	 *
	 * @param authenticationManagers a {@link Map} of
	 *                               {@link RequestMatcher}/{@link AuthenticationManager}
	 *                               pairs
	 */
	...
	/**
	 * Set the default {@link AuthenticationManager} to use when a request does not
	 * match
	 *
	 * @param defaultAuthenticationManager the default {@link AuthenticationManager}
	 *                                     to use
	 */
